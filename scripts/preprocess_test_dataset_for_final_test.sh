#!/bin/sh
# Usage preprocess_test_dataset <amr_aligned_file>
...
python amr_reader_for_test.py ../data/$amr_name/$amr_name.aligned > ../data/$amr_name/amr_nx_graphs 
...
python create_concept_dataset_for_test.py ../data/$amr_name/amr_nx_graphs.p ../data/$amr_name/amr_aggregated_metadata.p > ../data/$amr_name/concept_dataset
